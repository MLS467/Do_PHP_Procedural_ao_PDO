class Carrinho {
        ...
        this.pegaDadosEmJSON()
            .then(res => {
                ...
                if (res.valores.itens.length == 0) {
                    ...
                    document.getElementById('valorT').innerHTML = (res.valores.valorTotal.soma.toFixed(2));
    ...
    estruturaDoCarrinho = (produto) => {
        ...
        divValor.textContent = `Valor Unitário: R$${produto.valor}`;
