...
<body class="d-flex justify-content-start align-items-start w-100">
    <div id="caixa" class="containers w-75">
        ...
        <form class="w-75  d-flex justify-content-end d-flex  mb-3 d-flex align-items-center border shadow p-3 mb-5 ms-3 bg-body-tertiary rounded" action="valida_login.php" method="POST">
